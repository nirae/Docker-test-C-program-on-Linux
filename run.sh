...
# docker run --name c_test -ti --rm -e "EXE=./my_exec" nirae/test_c_on_linux

#
# Set all the env variables for a special Makefile Directory
#

# docker run --name c_test -ti --rm -e "MAKEFILE_DIR=test" -e "EXE=./test/my_exec" nirae/test_c_on_linux
